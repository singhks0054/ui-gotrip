          ...
          <div className='mt-8 overflow-hidden'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
              <div className='p-6 mr-2 bg-gray-100  sm:roundedLg'>
                ...
                <p className='text-normal textLg sm:text-2xl font-medium text-gray-600  mt-2'>
              ...
              <form className='p-6 flex flex-col justify-center'>
                <div className='flex flex-col'>
                  ...
                  <input
                    ...
                    className='w-100 mt-2 py-3 px-3 roundedLg bg-white  border border-gray-400 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none'
                  />
                </div>
                ...
                <button
                  type='submit'
                  className='md:w-32 bg-c2 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded mt-3 hover:bg-[#c6164e]  transition ease-in-out duration-300'
                >
                  Submit
                </button>
              </form>
